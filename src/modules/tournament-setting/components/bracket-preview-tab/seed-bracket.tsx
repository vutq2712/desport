...
export function BracketSeedBracket() {
  return (
    <>
      <div className='de-ts-bracket-preview-header de-mb-1'>
        <h4 className='de-mb-0'>Seed Bracket</h4>
      </div>
      <div className='de-notice'>
        <span>Registered teams: 64</span>
      </div>
      <div className='de-card'>
        <Row className='de-mb-2'>
          <Col lg='4'>
            <div className='de-form-group form-group'>
              <div className='de-form-control-with-icon'>
                ...
                <input className='de-form-control form-control' placeholder='Search team name...' />
              </div>
            </div>
          </Col>
          <Col lg='8' className='text-lg-end'>
            <button type='button' className='de-btn de-btn-outline-primary de-me-12px'>
              <span>invite</span>
            </button>
            <button type='button' className='de-btn de-btn-outline-primary de-me-12px'>
              <span>reset</span>
            ...
            <button type='button' className='de-btn de-btn-primary'>
        ...
        <div className='table-responsive'>
          <table className='table de-table table-borderless mb-0'>
            <tbody>
              <tr>
                <th>Team Name</th>
                <th className='text-center'>Seed No.</th>
                <th className='text-center'>Select</th>
                <th className='text-center'>Lock position</th>
              </tr>
              <tr>
                <td>
                  <img src='/assets/images/team-logo-3.png' alt='' height={32} />
                ...
                <td className='text-center'>
                  <button className={`de-switch ${1 === 1 ? 'checked' : ''}`} type='button'>
                    <span></span>
                  </button>
                </td>
                <td className='text-center'>
